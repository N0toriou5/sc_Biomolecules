...
#' @return null it plots a heatmap
#' @export
heatmap.3 <- function(x,
                      ...
                      col = function(n){colorpanel(n,"navy","white","red3")}, # "heat.colors",
                      colsep,
                      rowsep,
                      sepcolor = "white",
    ...
    if (missing(lmat) || is.null(lmat)) {
        ...
        if (!missing(ColSideColors)) {
            ...
            lhei=c(lhei[1], side.height.fraction*NumColSideColors*lheiMultiplier, lhei[2])
        }
